...
if __name__ == '__main__':
    ...
    parser.add_argument('--host', dest='host', help='Host to register', type=str, default=config['write_host'])
    parser.add_argument('--port', dest='port', help='Port to register', type=int, default=config['write_port'])
